            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="text-center animate-fade-in" style={{ animationDelay: '0.2s' }}>
                <div className="flex items-center justify-center mb-4">
                  ...
                  <h3 className="font-playfair text-2xl font-semibold text-charcoal">Music by</h3>
                </div>
                <p className="text-xl text-charcoal/80 font-medium">Georgy Fedorov</p>
              </div>
              
              <div className="text-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
                <div className="flex items-center justify-center mb-4">
                  <User className="w-6 h-6 text-orchestra-red mr-3" />
                  <h3 className="font-playfair text-2xl font-semibold text-charcoal">Narration by</h3>
                </div>
                <p className="text-xl text-charcoal/80 font-medium">Anastasia Lazareva</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl animate-fade-in">
              <CardContent className="p-8 text-center">
                <h2 className="font-playfair text-3xl font-bold text-charcoal mb-8">Event Details</h2>
                
                <div className="space-y-6 mb-8">
                  <div className="flex items-center justify-center">
                    <Calendar className="w-6 h-6 text-orchestra-red mr-4" />
                    <div>
                      <p className="text-2xl font-bold text-charcoal">December 22</p>
                      <p className="text-lg text-charcoal/70">Thursday</p>
                    </div>
                  </div>
